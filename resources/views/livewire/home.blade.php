<div>
    <div class="container col-xxl-8 px-4 py-4">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                <h1 class=" fw-bold lh-2 mb-3 text-success">Temukan Buku Favoritmu, Gratis & Gampang di Taman Baca Balarea 📚🌿</h1>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    ...
                    @guest   
                        <a href="{{ route('login') }}" class="btn btn-success btn-lg px-4 me-md-2 fw-bold">👉 Mulai Pinjam Sekarang</a>
                    @endguest

                    @auth
                        <a href="{{ route('daftar-buku') }}" class="btn btn-success btn-lg px-4 me-md-2 fw-bold">Daftar Buku</a>
                    @endauth
